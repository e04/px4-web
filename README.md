...
`px4_drv` の衛星対応チューナーをWebUSBで開き、ブラウザのみで地デジ・BS・110度CSの従来放送を視聴するアプリです。
...
- [px4_drv](https://github.com/tsukumijima/px4_drv)（オリジナル: [nns779/px4_drv](https://github.com/nns779/px4_drv)、Copyright (c) 2018-2021 nns779、GPL-2.0）。`it930x` ブリッジ、`r850` / `rt710` / `tc90522` / `cxd2856er` / `cxd2858er` チューナー制御、SmartCard T=1、TS同期を移植・参考（`src/driver`、`src/card`、`src/usb`、`wasm/tuner`）
